...
from vla_tmee.dataloader.gr00t_lerobot.datasets import ModalityConfig
from vla_tmee.dataloader.gr00t_lerobot.transform.base import ComposedModalityTransform, ModalityTransform
from vla_tmee.dataloader.gr00t_lerobot.transform.concat import ConcatTransform
from vla_tmee.dataloader.gr00t_lerobot.transform.state_action import (
    StateActionSinCosTransform,
    StateActionToTensor,
    StateActionTransform,
)
from vla_tmee.dataloader.gr00t_lerobot.transform.video import (
    VideoColorJitter,
    VideoCrop,
    VideoResize,
    VideoToNumpy,
    ...
    def transform(self):
        transforms = [
            ...
            StateActionTransform(
                ...
                normalization_modes={
                    "state.right_arm": "q99",
                    "state.right_hand": "binary",
                    "state.left_arm": "q99",
                    "state.left_hand": "binary",
                },
            ),
            # action transforms
            StateActionToTensor(apply_to=self.action_keys),
