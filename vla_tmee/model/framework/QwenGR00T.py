...
from vla_tmee.model.modules.action_model.GR00T_ActionHeader import get_action_model, FlowmatchingActionHead
    ...
    def forward(
        ...
        **kwargs,
        ...
        with torch.autocast("cuda", dtype=torch.float32):
            ...
            output_dict = self.action_model(last_hidden_repeated, actions_target_repeated, state_repeated)  # (B, chunk_len, action_dim)
...
if __name__ == "__main__":
    ...
    # try get model
    cfg.framework.qwenvl.base_vlm = "/share/project/baishuanghao/code/HLM-VLA/models/Qwen3-VL-2B-Instruct"
