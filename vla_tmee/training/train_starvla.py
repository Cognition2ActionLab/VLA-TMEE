...
# Local Modules
from vla_tmee.training.trainer_utils.trainer_tools import normalize_dotlist_args
from vla_tmee.model.framework import build_framework
from vla_tmee.training.trainer_utils.trainer_tools import TrainerUtils
from vla_tmee.training.trainer_utils.trainer_tools import build_param_lr_groups
...
from vla_tmee.dataloader import build_dataloader
    ...
    def _train_step(self, batch_vla, batch_vlm=None):
        ...
        with self.accelerator.accumulate(self.model):
            ...
            with torch.autocast("cuda", dtype=torch.bfloat16):
                ...
                if self.config.enable_mee:
                    mee_loss = output_dict["mee_loss"]
                    # total_loss = action_loss + mee_loss * self.config.mee_weight
        ...
        if self.config.enable_mee:
            return {
                "mse_loss": action_loss.item(),
                "mee_loss": mee_loss.item(),
                "totoal_loss": total_loss.item(),
            }
        else:
            return {
                "mse_loss": action_loss.item(),
