...
# cd /share/project/baishuanghao/code/VLA-TMEE && ./scripts/imbalance/libero/train/train_libero.sh gr00t libero_goal
...
for libero_suite in "${suites[@]}"; do
  ...
  /share/project/baishuanghao/miniconda3/envs/vla_tmee/bin/accelerate launch \
    ...
    --run_root_dir ./outputs_libero_imbalance/${libero_suite}_${para_type} \
    --run_id ${run_id} \
