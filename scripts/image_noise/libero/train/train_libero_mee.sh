...
# cd /share/project/baishuanghao/code/VLA-TMEE && ./scripts/image_noise/libero/train/train_libero_mee.sh dual libero_goal
...
image_noise_type=degradation_blur_motion
# image_noise_type=degradation_noise_sAp
...
for libero_suite in "${suites[@]}"; do
  ...
  /share/project/baishuanghao/miniconda3/envs/vla_tmee/bin/accelerate launch \
    ...
    --datasets.vla_data.enable_image_noise true \
    --datasets.vla_data.image_noise_type ${image_noise_type} \
    ...
    --run_root_dir ./outputs_libero_noise_image/${libero_suite}_${para_type}_${mee_type}_${mee_weight} \
    --run_id ${run_id} \
