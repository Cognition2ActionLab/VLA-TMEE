...
# cd /share/project/baishuanghao/code/VLA-TMEE && ./scripts/action_noise/libero/train/train_libero_mee.sh dual libero_goal
...
action_noise_type=cauchy    # cauchy impulse
...
for libero_suite in "${suites[@]}"; do
  ...
  /share/project/baishuanghao/miniconda3/envs/vla_tmee/bin/accelerate launch \
    ...
    --datasets.vla_data.enable_action_noise true \
    --datasets.vla_data.action_noise_type ${action_noise_type} \
    ...
    --run_root_dir ./outputs_libero_noise_action/${libero_suite}_${para_type}_${mee_type}_${mee_weight} \
    --run_id ${run_id} \
