...
# cd /share/project/baishuanghao/code/VLA-TMEE && ./scripts/action_noise/libero/train/train_libero.sh pi libero_goal
...
for libero_suite in "${suites[@]}"; do
  ...
  /share/project/baishuanghao/miniconda3/envs/vla_tmee/bin/accelerate launch \
    ...
    --run_root_dir ./outputs_libero_noise_action/${libero_suite}_${para_type} \
    --run_id ${run_id} \
