...
# cd /share/project/baishuanghao/code/VLA-TMEE && ./scripts/all/libero/train/train_libero_mee.sh dual libero_goal
...
for libero_suite in "${suites[@]}"; do
  ...
  /share/project/baishuanghao/miniconda3/envs/vla_tmee/bin/accelerate launch \
    ...
    --run_root_dir ./outputs_libero/${libero_suite}_${para_type}_${mee_type}_${mee_weight} \
    --run_id ${run_id} \
