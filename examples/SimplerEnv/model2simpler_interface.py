...
from vla_tmee.model.tools import read_mode_config
from vla_tmee.model.framework.base_framework import baseframework
from .add_noise import apply_image_perturbation
...
class M1Inference:
    def __init__(
        ...
        port=10093,
        enable_noise=False,
        OR_type="degradation_noise_sAp_1",
    ) -> None:
    ...
    def step(
        ...
        if self.enable_noise:
             if self.OR_type != None:
                parts = self.OR_type.split('_')
